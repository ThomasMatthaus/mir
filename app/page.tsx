      ...
      <main>
        ...
        <section className="py-12 md:py-20 lg:py-32">
          <div className="container text-center">
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 md:mb-8 leading-tight px-2">
              МИР НЕДВИЖИМОСТИ
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center mb-12 md:mb-16 px-4">
              <Link href="/contacts">
                <Button size="lg" className="w-full sm:w-auto text-lg md:text-xl px-8 md:px-12 py-6 md:py-8 button-large">
                  Получить консультацию
                  <ArrowRight className="ml-2 md:ml-3 w-5 h-5 md:w-6 md:h-6" />
                </Button>
              </Link>
              <Link href="/catalog">
                <Button variant="outline" size="lg" className="w-full sm:w-auto text-lg md:text-xl px-8 md:px-12 py-6 md:py-8 button-large">
                  Смотреть каталог
                </Button>
              </Link>
            </div>
          ...
          <div className="container">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center">
              <div>
                ...
                <p className="text-sm md:text-base lg:text-lg text-muted-foreground">Объектов в каталоге</p>
              </div>
              <div>
                <div className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-2">200+</div>
                <p className="text-sm md:text-base lg:text-lg text-muted-foreground">Довольных клиентов</p>
              </div>
              <div>
                <div className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-2">1</div>
                <p className="text-sm md:text-base lg:text-lg text-muted-foreground">Год на рынке</p>
              </div>
              <div>
                <div className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-2">24/7</div>
                <p className="text-sm md:text-base lg:text-lg text-muted-foreground">Поддержка клиентов</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              <Card className="text-center p-6 md:p-8">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4">Продажа</h3>
              ...
              <Card className="text-center p-6 md:p-8">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4">Аренда</h3>
                  <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              ...
              <Card className="text-center p-6 md:p-8">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4">Инвестиции</h3>
                  <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              ...
              <Card className="text-center p-6 md:p-8">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4">Ипотека</h3>
                  <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
        ...
        <section className="py-12 md:py-20">
          <div className="container text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 md:mb-8 px-4">
